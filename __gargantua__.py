...
import __scripts__.tk_commons as tktt
import sys
...
def full_menu(*args, wait=True, waitimg="", waittxt="", **kwargs):
    ...
    if wait == False:
        ...
        #root.wait.set_focus()
        threading.Thread(target=open_interface, args=[
                         root, *args], kwargs=kwargs).start()
...
class actvate_menu:
    def __init__(self, root, lib="open_flux", path=None, addons=[],
            ...
            try:
                ...
                try:
                    ...
                    try:
                        ...
                        func = gg.LazyCallable(str(os.path.join(pcd, '__main__.py')), fn).__get__().fc
